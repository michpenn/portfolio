...
define('ScrollMagic', ['jquery.masonry', 'TweenMax', 'TimelineMax'], function ($, TweenMax, TimelineMax) {
	/**
...
define('ScrollScene', ['jquery.masonry', 'TweenMax', 'TimelineMax'], function ($, TweenMax, TimelineMax) {
	/**
