(function ($) {
    ...
    var layoutManager = {
        defaultConfig: {
        ...
        }, plugin: {}, totalGrid: 1, transition: false, loadBlock: function (item, setting) {
            ...
            if ((fixSize != null) && (col > runtime.limitCol || row > runtime.limitRow)) {
                ...
                width == 0 && (col = 0);
                height == 0 && (row = 0);
                block = {id: blockId, width: col, height: row, fixSize: fixSize};
                if (fixPos) {
                    fixPos = fixPos.split("-");
                    block.y = 1 * fixPos[0];
                    block.x = 1 * fixPos[1];
                    ...
                    runtime.holes.push({top: block.y, left: block.x, width: block.width, height: block.height});
            ...
            function action() {
                ...
                if (!block) {
                    ...
                    $item[method]({left: left + width / 2, top: top + height / 2, width: 0, height: 0, opacity: 0});
                } else {
                    if (block.fixSize) {
                        block.height = 1 * $item.attr("data-height");
                        block.width = 1 * $item.attr("data-width");
                    }
                    $item["css"]({opacity: 1, width: block.width, height: block.height});
                    $item[method]({top: block.top, left: block.left});
            ...
            var touch = false;
            var def = {
                sX: 0, sY: 0, top: 0, left: 0, proxy: null, end: function () {
                }, move: function () {
                }, start: function () {
                }
            };
            $(item).each(function () {
                ...
                function mouseMove(evt) {
                    ...
                    $ele.css({top: set.top - (set.sY - evt.clientY), left: set.left - (set.sX - evt.clientX)});
                ...
                $(this).find("iframe, form, input, textarea, .ignore-drag").each(function () {
    ...
    var engine = {
        giot: function (items, setting) {
            var runtime = setting.runtime, row = runtime.limitRow, col = runtime.limitCol, x = 0, y = 0, maxX = runtime.totalCol, maxY = runtime.totalRow, wall = {}, holes = runtime.holes, block = null, matrix = runtime.matrix, bigLoop = Math.max(col, row), freeArea = null, misBlock = null, fitWidth = col < row ? 1 : 0, lastBlock = null, smallLoop = Math.min(col, row);
            ...
            for (var b = 0; b < bigLoop; ++b) {
                ...
                for (var s = 0; s < smallLoop; ++s) {
                    ...
                    if (block != null) {
                        ...
                        var misBlock = {x: x, y: y, fixSize: 0};
                        if (fitWidth) {
    ...
    window.freewall = function (selector) {
        ...
        function setDragable(item) {
            ...
            layoutManager.setDragable(item, {
                start: function (event) {
                    ...
                    top = Math.min(Math.max(0, top), runtime.limitRow - height);
                    left = Math.min(Math.max(0, left), runtime.limitCol - width);
                    $(this).css({zIndex: "auto", top: top * cellH, left: left * cellW}).removeClass('fw-float');
                    klass.fillHoles();
                }
            });
        }
        ...
        $.extend(klass, {
            addCustomEvent: function (name, func) {
                ...
                return this;
            }, container: container, fillHoles: function () {
                runtime.holes = [];
                return this;
                ...
                var allBlock = container.find(setting.selector).removeAttr('id'), block = null, activeBlock = [];
